...
namespace System.Net.Http
{
    ...
    public static class HttpClientExtensions
    {
        ...
        /// <summary>
        /// Sends a PATCH request as an asynchronous operation, with a specified value serialized as JSON. Includes a cancellation token to cancel the request.
        /// </summary>
        /// 
        /// <returns>
        /// A task object representing the asynchronous operation.
        ...
        /// <summary>
        /// Sends a PATCH request as an asynchronous operation, with a specified value serialized as XML. Includes a cancellation token to cancel the request.
        /// </summary>
        /// 
        /// <returns>
        /// A task object representing the asynchronous operation.
        ...
        /// A task object representing the asynchronous operation.
        /// </returns>
        /// <param name="client">The client used to make the request.</param><param name="requestUri">The URI the request is sent to.</param><param name="value">The value to write into the entity body of the request.</param><param name="formatter">The formatter used to serialize the value.</param><typeparam name="T">The type of object to serialize.</typeparam>
        ...
        /// <summary>
        /// Sends a PATCH request as an asynchronous operation, with a specified value serialized using the given formatter. Includes a cancellation token to cancel the request.
        /// </summary>
        /// 
        /// <returns>
        /// A task object representing the asynchronous operation.
        ...
        /// <summary>
        /// Sends a PATCH request as an asynchronous operation, with a specified value serialized using the given formatter and media type string.
        /// </summary>
        /// 
        /// <returns>
        /// A task object representing the asynchronous operation.
        /// </returns>
        /// <param name="client">The client used to make the request.</param><param name="requestUri">The URI the request is sent to.</param><param name="value">The value to write into the entity body of the request.</param><param name="formatter">The formatter used to serialize the value.</param><param name="mediaType">The authoritative value of the Content-Type header. Can be null, in which case the  default content type of the formatter will be used.</param><typeparam name="T">The type of object to serialize.</typeparam>
        ...
        /// <summary>
        /// Sends a PATCH request as an asynchronous operation, with a specified value serialized using the given formatter and media type string. Includes a cancellation token to cancel the request.
        /// </summary>
        /// 
        /// <returns>
        /// A task object representing the asynchronous operation.
        ...
        /// <summary>
        /// Sends a PATCH request as an asynchronous operation, with a specified value serialized using the given formatter and media type.
        /// </summary>
        /// 
        /// <returns>
        /// A task object representing the asynchronous operation.
