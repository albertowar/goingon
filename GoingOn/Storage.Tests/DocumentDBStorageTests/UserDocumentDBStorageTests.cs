...
namespace Storage.Tests.DocumentDBStorageTests
{
    using Common.Tests;
    using Microsoft.VisualStudio.TestTools.UnitTesting;
    using Model.EntitiesBll;
    using Storage.DocumentDBStorage;

    [TestClass]
    public class UserDocumentDBStorageTests
    {
        ...
        {
            storage = UserDocumentDBStorage.GetInstance();
        }
